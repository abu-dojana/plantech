...
<body>
   ...
   <h1>Soil Moisture info & Calibration</h1>
    ...
    <script>
            ...
            fetch('/sensorData')
                ...
                .then(data => {
                    document.getElementById('sensorData').innerHTML = `
                        ...
                        <p>Calibrated Wet Value (Low): ${data.wetValueLow}</p>
                        <p>Calibrated Dry Value (High): ${data.dryValueHigh}</p>
        ...
        setInterval(updateSoilSensorData, 1000);  // Fetch sensor data every second
        updateSoilSensorData();  // Initial update
    </script>
